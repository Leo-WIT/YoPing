...
namespace vmPing.Classes
{
    internal static class Util
    {
        public static async void SendEmail(string status, string hostname, string alias)
        {
            try
            {
                using (MailMessage message = new MailMessage())
                {
                    ...
                    message.From = new MailAddress(ApplicationOptions.EmailFromAddress, "YoPing");
            ...
            string recipientAddress)
        {
            using (MailMessage message = new MailMessage())
            {
                message.Subject = "[YoPing] Test Email Notification";
                message.Body = $"This is a test email sent by YoPing on {DateTime.Now:F}";
                message.From = new MailAddress(fromAddress, "YoPing");
