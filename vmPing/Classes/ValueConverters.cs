...
namespace vmPing.Classes
{
    ...
    public class BooleanToPlayStopGlyphConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value is bool v && v ? "■" : "▶";
    ...
    internal static class ProbeBrushHelper
    {
        ...
        public static Brush FromResource(string key)
        {
            try
            {
    ...
    public class ProbeStatusToBackgroundBrushConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch ((ProbeStatus)value)
            {
                ...
                default:
                    if (ApplicationOptions.Theme == ApplicationOptions.ThemeMode.Dark)
                    {
                        return ProbeBrushHelper.FromResource("Theme.Brush.Container");
                    }
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch ((ProbeStatus)value)
            {
                ...
                default:
                    if (ApplicationOptions.Theme == ApplicationOptions.ThemeMode.Dark)
                    {
                        return ProbeBrushHelper.FromResource("Theme.Brush.Text");
                    }
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch ((ProbeStatus)value)
            {
                ...
                default:
                    if (ApplicationOptions.Theme == ApplicationOptions.ThemeMode.Dark)
                    {
                        return ProbeBrushHelper.FromResource("Theme.Brush.TextMuted");
                    }
    ...
    public class ProbeCountToGlobalStartStopGlyph : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            long count = (value is long v) ? v : 0;
